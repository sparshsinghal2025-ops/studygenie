...
async function ask(){
  ...
  // SECRET DEV UNLOCK - Naam se independent
  ...
  if(q.toLowerCase() === "genielock"){
    localStorage.setItem("sg_is_founder","false");
    alert("Dev mode locked");
    updateUI();
    return;
  }
