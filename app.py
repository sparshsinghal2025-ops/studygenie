...
<div class="flex justify-between items-center glass rounded-2xl px-4 py-3 mb-4">
  <div class="flex items-center gap-3">
    ...
    <div>
      <h1 class="text-lg md:text-2xl font-black tracking-tight">StudyGenie <span class="text-orange-400">by Sparsh Singhal</span></h1>
...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
  <div class="lg:col-span-3 glass rounded-[24px] p-3 md:p-4 flex flex-col min-h-[75vh]">
    <div id="chat" class="flex-1 space-y-4 overflow-y-auto pr-1 max-h-[60vh] md:max-h-none">
      <div class="bubble-ai p-4 rounded-2xl rounded-bl-none max-w-[92%] text-sm leading-relaxed">Hukm mere aaka! 🧞 <b>Mai Sparsh Singhal ka Genie hu!</b> Ab mai aapke saath hu! 😎<br><span class="text-xs opacity-60">Pucho kuch bhi, mai pura bolke samjhaunga.</span></div>
    </div>
